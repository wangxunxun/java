...
public class CommonTools {
	...
	public static void createWorkbook(String excelDir,String excelName,String className,int index) throws IOException, WriteException, BiffException{
	    ...
	    String navigation[] = { "Summary", "Test ", "Pass", "Failed", "Skip",
	            "Success rate", "Time Consuming" };
	    String classNavigation[] = { "Test Suite", "Success Rate","Log","Test Case", 
	              "Time Consuming",  "Error Screenshot", "Comment" ,"Status"};
